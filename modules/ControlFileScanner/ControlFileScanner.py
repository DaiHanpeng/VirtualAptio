...
from ..InlabbingPosition.SampleInlabbingPosition  import SampleInlabbingPosition
from ..Position2Flag.SamplePosition2FlagStratege import SamplePosition2FlagStratege
from ..AptioReagent.ReagentStatusUpdateStrategy import g_ReagentStatusUpdateStrategy
from ..Logging.LoggingConfig import project_logger
from .GetLatestPackedControlFile import GetLatestPackedControlFile
from ..AptioReagent.Aptio_Reagent_Info import *
...
class ControlFileScanner(object):
    ...
    def clear_sample_flag_info_list(self):
        self.sample_flag_info_list = []
    ...
    def scan_control_file_for_reagent_info(self):
        ...
        if self.control_file_contents:
            for line in self.control_file_contents:
                if line.find('INVENTORY') > 0:
                    ...
                    if instrument_reagent_info:
                        ...
                        self.aptio_reagent_info.add_instrument_reagent_info_table(instrument_reagent_info)
                        update_reagent_flag = True

                    if True == update_reagent_flag:
            ...
            g_ReagentStatusUpdateStrategy.update_reagent_status_from_aptio_reagent_info_list(self.aptio_reagent_info)

    def aptio_reagent_status_processing(self):
